        ...
        <div className="proyectsGrid">
          ...
          >
            <div className="proyectsCard">
              ...
              <p>
                ...
                mascotas y pedir cita solicitando servicios concretos, así como
                el empleado y la fecha que desees. De igual forma, los
                trabajadores podrán registrarse y ver sus horarios laborales e
                historial de citas.
              </p>
            </div>
          </a>
          ...
          >
            <div className="proyectsCard">
              ...
              <p>
                En esta página web podrás registrarte como jugador y añadir
                juegos de mesa y/o telemáticos a tu perfil, dando datos y
                reseñas personales. Para añadir un juego, necesitas dar
                información sobre el título, plataforma, año de creación, entre
                otros. Además podrás ver los juegos de los demás perfiles
                registrados.
              </p>
            </div>
          </a>
          ...
          >
            <div className="proyectsCard">
              <img
                src={`${base}img/proyects/simpsons.png`}
                alt="The Simpsons"
              />
              <h3>The Simpsons</h3>
              <p>
                ...
                aparecerán distintos tríos de personajes con algunas de sus
                frases más icónicas.
              </p>
            </div>
          </a>
